   ...
   useEffect(()=>{
    ...
    return (
        <>
            ...
            <div className="navbar-mains" 
              style={{overflow:'hidden'}}
            >

            {
              !mainLogoIsLoading && 
              <Imagecomp source={`${backendaddress}/images/mainLogo/`+ mainLogo[0]} 
                id="navbar-logo" 
            ...
            { 
            window.matchMedia("(max-width: 934px)").matches ?
            localStorage.getItem("theme")=="dark" ?
            <i className="fa-sharp fa-light fa-moon-over-sun" 
              style={{ transform:'scale(1.5)', background: 'rgb(28 48 84)',padding:'0.3rem', borderRadius: '2rem',color: 'rgb(173 244 255)'}} 
              onClick={handleThemeClick}></i> :
            <i className="fa-sharp fa-light fa-moon" 
              style={{color:'var(--black)', transform:'scale(1.5)', color:' #005aff', background: '#f6f6ff', borderRadius: '50%', padding: '0.3rem 0.4rem'}} 
              onClick={handleThemeClick}></i> :""
            }
            ...
            <ul className={ulClassList} style={isLoggedIn ? { overflow: 'visible', flexWrap: 'wrap' } : null}>
              <li className="main-nav-li">
                <a href="/">
                  <i className="fa-duotone fa-camera-retro nico"></i>Portfolio
                </a>
              </li>
              <li className="main-nav-li">
                <a href="/overview">
                  <i className="fa-sharp fa-solid fa-file-magnifying-glass nico"></i>Overview
                </a>
              </li>
              <li className="main-nav-li">
                <a href="/management">
                  <i className="fa-solid fa-list-check nico"></i>Management
                </a>
              </li>
              <li className="main-nav-li">
                <a href="/contact">
                  <i className="fa-solid fa-address-book nico"></i>Contact
                </a>
              </li>
              {
                isLoggedIn ? 
                <>
                  <li className="main-nav-li adminli" 
                    style={{background:'var(--themecolor)', overflow:'hidden'}}>
                      <a href="/$admin" 
                        style={{overflow:'visible'}}
                      >
                      <i className="fa-solid fa-wrench" 
                        style={{transform:'scale(2)', color:'white'}}></i>
                      </a>
                  </li>
                </> : "" 
              }
              ...
              <li className="main-nav-li">
                <a href="#" 
                  onClick={handleLogout}>
                    <i className="fa-sharp fa-solid fa-arrow-right-from-bracket nico"></i>Logout
                </a>
              </li> 
              </> : ""
              } 
              { 
              window.matchMedia("(min-width: 934px)").matches ? 
              localStorage.getItem("theme")=="dark" ? 
